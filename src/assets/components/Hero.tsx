...
const Hero = () => {
    return (
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden w-full bg-linear-to-br from-black via-gray-900 to-black">
            <img
                src={heroBg}
                alt="Hero background"
            ...
            <div className="relative z-10 text-center max-w-[600px] sm:px-3 md:px-6 flex flex-col items-center w-full">
                <div className="text-white">
                    <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold leading-tight mb-6 drop-sha12dow-lg">

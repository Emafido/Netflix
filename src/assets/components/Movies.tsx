...
const Movie_Data = [
  {
    ...
    results: [
      ...
      {
        adult: false,
        backdrop_path: "/1hDUJFAYkLJUCoiXzDi2cLmFh4m.jpg",
        genre_ids: [28, 18, 14],
        id: 1083637,
      ...
      {
        adult: false,
        backdrop_path: "/lf8IZ86ajGpgbuyHCZrXUeAMmvy.jpg",
        genre_ids: [28, 12, 878],
        id: 1033462,
        original_language: "zh",
        original_title: "749局",
      ...
      {
        adult: false,
        backdrop_path: "/q9bvjUkpKltPE0S9oxci2pmD1Zx.jpg",
        genre_ids: [878, 28],
        id: 1309012,
        original_language: "en",
...
const TrendingNow = () => {
  return (
    <div className="px-6 mt-6">
      <h3>Trending Now</h3>
      <div>
        {Movie_Data[0].results.length > 0 ? (
          <MovieList movies={Movie_Data[0].results} />
        ) : (
